...
const problemResults = [
  ...
  "lucro menor do que deveria existir",
];

const mechanismCards = [
  {
    title: "Custos reais consolidados",
    description: "O sistema reúne custos fixos, materiais, tempo clínico e impostos para calcular o preço com base concreta.",
    icon: Landmark,
  },
  {
    title: "Lógica automática de rentabilidade",
    description: "A plataforma entrega a formação do preço e mostra, com clareza, onde estão custo direto, operação, impostos e margem.",
    icon: Calculator,
  },
  {
          ...
          <section className="glass card public-section-block public-problem-section">
            ...
            <div className="public-problem-grid">
              <div className="public-problem-copy">
                <p>Existe um erro silencioso que acontece em milhares de consultórios.</p>
                <p>Os preços dos procedimentos são definidos com base em:</p>
                <div className="public-list-grid compact">
                  {problemPoints.map((item, index) => (
                    <ScrollReveal key={item} delayMs={index * 70}>
                      <div className="public-list-card">{item}</div>
                    </ScrollReveal>
                  ))}
                </div>
                <p>O problema é que isso quase nunca reflete o custo real do procedimento.</p>
              </div>
              <div className="public-problem-impact">
                <div className="public-impact-card">
                  <span className="landing-mini-label">Resultado</span>
                  <h3>Agenda cheia, pressão alta e lucro abaixo do que o negócio deveria gerar.</h3>
                  <div className="public-list-grid stacked">
                    {problemResults.map((item, index) => (
                      <ScrollReveal key={item} delayMs={index * 80}>
                        <div className="public-benefit-line">
        ...
        <ScrollReveal>
          <section className="glass card public-section-block public-mechanism-section">
            ...
            <div className="public-feature-grid three-up">
              {mechanismCards.map((item, index) => {
                const Icon = item.icon;
                return (
                  <ScrollReveal key={item.title} delayMs={index * 90}>
                    <article className="stat public-feature-card">
          ...
          <section id="como-funciona" className="glass card public-section-block">
            ...
            <div className="public-step-grid">
              {steps.map((item, index) => {
                ...
                return (
                  <ScrollReveal key={item.title} delayMs={index * 90}>
                    <article className="public-step-card">
              ...
              {factors.map((item, index) => {
                ...
                return (
                  <ScrollReveal key={item.title} delayMs={index * 70}>
                    <div className="public-factor-card">
            ...
            <div className="public-impact-layout">
              <div className="public-impact-side">
                {transformations.map((item, index) => (
                  <ScrollReveal key={item} delayMs={index * 80}>
                    <div className="public-benefit-line strong">
                      <CheckCircle2 size={18} />
                      <span>{item}</span>
                    </div>
                  </ScrollReveal>
